...
SELECT TOP 1 l.[Id_client], COUNT(c.[Id_com]) as 'lol'
	FROM [stri16].[dbo].[COMMANDE] c, [stri16].[dbo].[CLIENT] l
	WHERE c.[Id_client] = l.[Id_client]
	GROUP BY l.[Id_client] ORDER BY lol desc
;

-- 10) 

SELECT TOP 1 l.[Id_client], COUNT(d.[Qt_dc]) as 'lol'
	...
	GROUP BY d.[Id_com], l.[Id_client] ORDER BY lol desc
;
